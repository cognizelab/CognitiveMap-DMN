function out_lesion = mask_lesion_ridge(xtest,ytest,model,out_train,temporary_file,param)
...
for i = 1:numel(unique(mask))
    ...
    out_train_temp.model = out_train_temp.model(f1);
    ...
    out_train_temp = out_train; 
    out_train_temp.model = out_train_temp.model(f2);
