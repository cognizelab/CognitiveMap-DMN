function [opt_parameter,opt_records,param] = get_opt_params_svr(x,y,param)
...
for m = 1:numel(param.C)
    ...
    for n = 1:param.icv(2)
        ...
        for k = 1:param.icv(1)
            ...
            % model training
            [out_train,temporary_file] = train_model_svr(xtrain,ytrain,parameter,kk);
        ...
        curr = mat_assess_correlation(PV,TV,param);
        model_quality_out(n,1) = curr.accuracy;
        model_quality_out(n,2) = curr.MAE;   
    end
