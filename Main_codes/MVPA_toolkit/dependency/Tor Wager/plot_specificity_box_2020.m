function out = plot_specificity_box_2020(y1, y2, varargin)
...
data = [y1 y2];
boxplot_wani_2020(data, 'color', cols, 'linewidth', 2, 'boxlinewidth', 1, 'mediancolor', 'k', 'violin', 'samefig');
...
if ~isempty(ylims)
    set(gca, 'fontsize', 18,'ylim',ylims, 'xlim', [0.5 2.5], 'linewidth', 1.5, 'ticklength', [.03 .03], 'xticklabel', '');
else
