function [h, stats] = ind_xylines_2020(X, Y, varargin)
...
for i = 1:subjn
    ...
    if doindline
        h.ind(i,1) = line(stats.newX{i}, stats.newY{i}, 'color', ind_colors(i,:), 'linewidth', ind_linewidth, 'linestyle', ind_linestyle);
    end
end
